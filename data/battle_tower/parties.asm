...
; BattleTowerMons group 2
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, SOFTBOILED, COUNTER, NO_MOVE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 3
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, FISSURE, NO_MOVE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db PINSIR
	db GOLD_BERRY
	db HYPER_BEAM, STRENGTH, TOXIC, NO_MOVE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, ROCK_SMASH, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 10
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, EARTHQUAKE, HYPER_BEAM, ROCK_SMASH
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
