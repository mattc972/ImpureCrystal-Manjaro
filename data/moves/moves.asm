...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move ARM_THRUST,   EFFECT_MULTI_HIT,          15, FIGHTING,      PHYSICAL, 100, 20,   0
	...
	move CUT,          EFFECT_ATTACK_UP_HIT,      40, BUG,           PHYSICAL, 100, 20, 100
	...
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          60, BUG,           PHYSICAL, 100, 15,   0 ;
	...
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, PSYCHIC_TYPE,  PHYSICAL, 100, 10,  20
