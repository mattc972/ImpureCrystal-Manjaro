...
BrunoGroup:
	...
	db 46, MACHAMP,    ROCK_SLIDE, FORESIGHT, ROCK_SMASH, CROSS_CHOP
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 35, VICTREEBEL, BIND, TOXIC, ACID, RAZOR_LEAF
	...
	; COOLTRAINERM (10)
	db "GAVEN@", TRAINERTYPE_MOVES
	db 32, VICTREEBEL, BIND, TOXIC, ACID, RAZOR_LEAF
	...
	db 37, DRAGONAIR,  BIND, SURF, DRAGON_RAGE, SLAM
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     BUBBLE, LEER, BITE, HARDEN
...
BlackbeltGroup:
	...
	db 38, MACHAMP,    HEADBUTT, SWAGGER, THUNDERPUNCH, ROCK_SMASH
	...
	db 27, HITMONCHAN, ARM_THRUST, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, ARBOK,      BIND, POISON_STING, BITE, GLARE
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 23, ARBOK,      BIND, LEER, POISON_STING, BITE
...
GruntFGroup:
	...
	db 18, EKANS,      BIND, LEER, POISON_STING, BITE
